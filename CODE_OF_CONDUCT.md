...
This Code of Conduct applies within all project spaces — including the GitHub repository, issues, pull requests, and any other official communication channel — and also applies when an individual is officially representing the project in public spaces.

---

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the project maintainer via the contact information in their GitHub profile.
